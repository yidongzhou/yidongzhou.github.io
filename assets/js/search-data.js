...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-honored-to-share-that-our-paper-deep-fréchet-regression-has-been-selected-as-the-discussion-paper-for-the-journal-of-the-american-statistical-association-theory-amp-amp-methods-invited-session-at-the-2026-joint-statistical-meetings-the-invited-session-will-take-place-on-monday-august-3rd-10-30am-12-20pm-as-a-discussion-paper-our-work-will-be-accompanied-by-invited-discussions-and-contributed-comments-followed-by-a-rejoinder",
          title: 'Honored to share that our paper, Deep Fréchet Regression, has been selected as...',
          description: "",
          section: "News",},{id: "news-thrilled-to-announce-that-our-paper-end-to-end-deep-learning-for-predicting-metric-space-valued-outputs-has-been-accepted-for-publication-in-the-journal-of-machine-learning-research-in-this-work-we-introduce-e2m-an-end-to-end-deep-learning-framework-for-predicting-metric-space-valued-outputs-via-geometry-aware-weighted-fréchet-means",
          title: 'Thrilled to announce that our paper, End-to-End Deep Learning for Predicting Metric Space-Valued...',
          description: "",
          section: "News",},{id: "news-thrilled-to-announce-that-our-paper-deep-single-index-fréchet-regression-has-been-accepted-to-icml-2026-in-this-work-we-propose-desi-a-semiparametric-deep-single-index-framework-for-fréchet-regression-with-metric-space-valued-outputs-and-high-dimensional-inputs",
          title: 'Thrilled to announce that our paper, Deep Single-Index Fréchet Regression, has been accepted...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=MjugrtIAAAAJ", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/yidongzhou", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0003-1423-1857", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/aweydzhou", "_blank");
        },
      },{
      id: 'light-theme',
